...
const T = {
  en: {
    ...
    faqs: [
      { q: 'Do unused classes expire?', a: 'No, never. Once you buy a pack the classes are yours to use at your own pace.' },
      { q: 'Can I cancel?', a: "There's nothing to cancel — it's a one-time payment, not a subscription. Your classes never expire." },
      { q: 'Change plans?', a: 'Each pack simply stacks its classes onto your balance. Buy any pack, anytime — they add up.' },
    ],
  ...
  es: {
    ...
    faqs: [
      { q: '¿Las clases sin usar expiran?', a: 'No, nunca. Una vez que compras un paquete, las clases son tuyas para usarlas a tu ritmo.' },
      { q: '¿Puedo cancelar?', a: 'No hay nada que cancelar — es un pago único, no una suscripción. Tus clases nunca caducan.' },
      { q: '¿Cambiar de plan?', a: 'Cada paquete suma sus clases a tu saldo. Compra el que quieras, cuando quieras — se acumulan.' },
    ],
