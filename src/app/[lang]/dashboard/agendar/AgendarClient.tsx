...
const t = {
  en: {
    ...
    saldoSub: (n: number) => `${n} classes · they never expire`,
    ...
    classesPill: (n: number) => `${n} classes in your balance`,
  ...
  es: {
    ...
    saldoSub: (n: number) => `${n} clases · no expiran`,
    ...
    classesPill: (n: number) => `${n} clases en tu saldo`,
