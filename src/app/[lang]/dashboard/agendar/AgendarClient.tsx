...
const t = {
  en: {
    ...
    booked: 'Booked',
    tooSoon: 'Too soon',
    anyTimeNote: 'Each session is 60 minutes. Book any time at least 24h ahead — a teacher is assigned within 24h of your booking.',
  ...
  es: {
    ...
    booked: 'Ocupada',
    tooSoon: 'Muy pronto',
    anyTimeNote: 'Cada clase dura 60 minutos. Agenda con al menos 24h de anticipación — asignamos maestro dentro de las 24h posteriores a tu reserva.',
