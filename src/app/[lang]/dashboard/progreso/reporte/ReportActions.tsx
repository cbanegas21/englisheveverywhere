...
// report page's print stylesheet. window.print() lets the browser print or
// "Save as PDF", so the report downloads with no PDF dependency (same pattern as
// the receipt route).
export default function ReportActions({ backHref, printLabel, backLabel }: Props) {
  return (
