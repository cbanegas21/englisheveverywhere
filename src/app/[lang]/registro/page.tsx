...
const t = {
  en: {
    ...
    studentRole: 'Student',
    teacherRole: 'Teacher',
    studentSub: 'I want to learn English with near-native Latin American teachers.',
  ...
  es: {
    ...
    teacherRole: 'Maestro',
    studentSub: 'Quiero aprender inglés con maestros latinoamericanos casi nativos.',
