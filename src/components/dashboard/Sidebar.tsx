...
const studentNav = {
  en: [
    ...
    { label: 'The Workshop', href: '/dashboard/lab', badge: 'New' },
  ...
  es: [
    ...
    { label: 'El Taller', href: '/dashboard/lab', badge: 'Nuevo' },
...
const teacherNav = {
  en: [
    ...
    { label: 'Question bank', href: '/maestro/dashboard/banco', badge: 'New' },
    { label: 'Quizzes', href: '/maestro/dashboard/quizzes', badge: 'New' },
  ...
  es: [
    ...
    { label: 'Banco de preguntas', href: '/maestro/dashboard/banco', badge: 'Nuevo' },
    { label: 'Quizzes', href: '/maestro/dashboard/quizzes', badge: 'Nuevo' },
