...
const t = {
  en: {
    ...
    contact: {
      ...
      bestWayAccent: 'free discovery class.',
      bestWayEnd: ' You meet a real teacher, find your level and build your plan — no bots, no pressure, no card.',
      cta: 'Book my free class',
    },
    items: [
      { q: 'Is the first class really free?', a: 'Yes. Your first class is a free discovery class — you meet your teacher, find your level and map out a plan. No card, no commitment.' },
      { q: 'How do I book my first class?', a: 'Sign up, book your free discovery class, and when you’re ready, choose a pack and book any hour you like.' },
      { q: 'What level do I need to start?', a: 'Any level, from A0 to C2. Your free discovery class sets your level and where to begin.' },
  ...
  es: {
    ...
    contact: {
      ...
      bestWayAccent: 'clase de descubrimiento gratis.',
    ...
    items: [
      { q: '¿La primera clase es de verdad gratis?', a: 'Sí. Tu primera clase es una clase de descubrimiento gratis — conoces a tu maestro, descubres tu nivel y armas un plan. Sin tarjeta, sin compromiso.' },
      { q: '¿Cómo reservo mi primera clase?', a: 'Te registras, reservas tu clase de descubrimiento gratis y, cuando estés listo, eliges un paquete y reservas a la hora que quieras.' },
      { q: '¿Qué nivel necesito para empezar?', a: 'Cualquiera, de A0 a C2. Tu clase de descubrimiento gratis define tu nivel y por dónde empezar.' },
