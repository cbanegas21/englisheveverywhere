...
const t = {
  en: {
    ...
    ctaNote: 'New here? Start with a free diagnostic call — meet a real teacher, find your level. No card needed.',
  ...
  es: {
    ...
    ctaNote: '¿Nuevo por aquí? Empieza con una llamada de diagnóstico gratis — conoce a un maestro de verdad y descubre tu nivel. Sin tarjeta.',
