...
- **Open next:** the rest of 🟠 high (EK-010 onboarding level, EK-011 teacher self-lockout, EK-012/016/050 primary_teacher_id sourcing, EK-013/014/015/017 admin booking/refund correctness, EK-018 teacher confirm/decline [needs product decision], EK-019/044/045/046 timezone, EK-020/021/022 video, EK-023 payouts, EK-024 responsive, EK-025 html lang, EK-026 privacy ES, EK-028 level-set security, EK-029 ganancias cap) → then medium → low.
