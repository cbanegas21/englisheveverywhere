...
- **Open next:** 🟡 MEDIUM TRIAGE (launch-relevant: EK-052 payment receipts, EK-036 navbar on legal pages, EK-035 subscription-framing copy, EK-031 dead Hero card, EK-051 admin level auto-save, EK-060 cancelled-tab, EK-053 fabricated progress stats) → then ⚪ low / polish. Deferred: EK-046, EK-015 email, EK-023.
